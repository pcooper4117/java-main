...
-- to get the differece we can use a subquery or a left join
...
--
-- since the actor id is generated by the database manager we dont specify it in the insert
-- which means the actor id may be different on different databases managers

select a.actor_id, a.first_name, a.last_name
from actor a                    -- nicknames for ease of coding
left join
film_actor fa
